...
public class AI : MonoBehaviour
{
	...
	protected void followTarget(Vector3 target, Vector3 toTarget)
	{
		...
		if(toTarget.magnitude >= stopDist )
		{
			...
			entity.body.AddForce(toPrediction.normalized * ship.stats.moveSpeed, ForceMode.Acceleration);
		}
	...
	protected void patrol()
	{
		...
		entity.body.AddForce(toTarget.normalized * ship.stats.moveSpeed, ForceMode.Acceleration);
	}
}
